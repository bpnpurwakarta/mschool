	...
	function simpan_file(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$tmpat_tgl_lahir=$this->input->post('xtmpat_tgl_lahir');
							$file_tanggal=strip_tags($this->input->post('xfile_tanggal'));
							$alamat=strip_tags($this->input->post('xalamat'));
							$email=$this->input->post('xemail');
							$no_hp=$this->input->post('xno_hp');
	
							$this->m_files->simpan_file($nama_lengkap,$tmpat_tgl_lahir,$file_tanggal,$alamat,$email,$no_hp);
