...
<div class="wrapper">
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                       ...
                       $guru_tmp_lahir=$i['guru_tmp_lahir'];
                ...
                <tr>
                  ...
                  <td><?php echo $guru_tmp_lahir;?></td>
                  <td><?php echo $guru_jenkel;?></td>
                  <td><?php echo $jabatan;?></td>
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $NIP;?>"><span class="fa fa-pencil"></span></a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="http://mfikri.com">Reynald Pradana</a>.</strong> All rights reserved.
  </footer>
...
<!-- ./wrapper -->
  ...
  <?php foreach ($data->result_array() as $i) :
              $NIP=$i['NIP'];
              $nama=$i['nama_pegawai'];
              $alamat=$i['alamat_pegawai'];
            ?>

        <div class="modal fade" id="ModalEdit<?php echo $NIP;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
